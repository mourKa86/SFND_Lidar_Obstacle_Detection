...
std::unordered_set<int> RansacPlain(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, int maxIterations, float distanceTol)
{
	std::unordered_set<int> inliersResult;
	srand(time(NULL));
...
int main ()
{
	...
	std::unordered_set<int> inliers = RansacPlain(cloud, 10, 1.0);
